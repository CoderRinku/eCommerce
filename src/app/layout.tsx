...
export default function RootLayout({
  ...
  return (
    ...
    >
      ...
      <body className="min-h-full flex flex-col bg-background text-foreground transition-colors duration-300 selection:bg-indigo-500/30 selection:text-indigo-200">
        <AppProviders>
          <Navbar />
