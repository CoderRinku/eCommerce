...
export default function CheckoutPage() {
  ...
  useEffect(() => {
    if (status === 'unauthenticated') {
      toast('Please sign in to complete checkout', 'info');
  ...
  const shippingCharge = district === 'Inside Dhaka' ? 60 : 120;
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
        ...
        <div className="lg:col-span-2 space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-neutral-900 border border-white/5 text-sm text-white focus:outline-none focus:border-indigo-500/50"
                />
              </div>
              <div>
                <label className="block text-xs font-semibold text-neutral-400 mb-2 uppercase">
          ...
          <div className="rounded-2xl glass-card p-6 space-y-6">
            ...
            {paymentMethod !== 'COD' && (
              <div className="p-4 rounded-xl bg-indigo-500/5 border border-indigo-500/15 text-xs text-indigo-400 flex items-center gap-3">
        ...
        <div className="rounded-2xl glass-card p-6 space-y-6">
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full flex items-center justify-center gap-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 py-3.5 text-sm font-bold text-white transition-all shadow-xl shadow-indigo-600/10 cursor-pointer disabled:bg-neutral-800 disabled:text-neutral-500"
          >
            {submitting ? (
              <>
